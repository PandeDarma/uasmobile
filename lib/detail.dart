...
class _DetailState extends State<Detail> {
  ...
  void deleteData(){
    var url="http://192.168.43.80:8080/api_pariwisata/deletedata.php";
    http.post(url, body: {
        ...
        child: new Card(
          child: new Center(
            child: new Column(
              ...
              new Text("Jenis Kamar : ${widget.list[widget.index]['harga']}", style: new TextStyle(fontSize: 18.0),),
              new Text("Lama : ${widget.list[widget.index]['lama'] } Hari", style: new TextStyle(fontSize: 18.0),),
